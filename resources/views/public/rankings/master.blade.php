@extends('layouts.app')
@section('title', 'Master Level Rankings')
@section('content')
...
<table class="table table-striped table-condensed">
    <thead>
        <tr><th>#</th><th>Class</th><th>Character</th><th>Master Level</th><th>Level</th><th>Resets</th></tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>{{ number_format($char->mLevel) }}</td>
            <td>{{ number_format($char->cLevel) }}</td>
            <td>{{ number_format($char->RESETS ?? 0) }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
